...
<div class="body" id="body">
    ...
    <div class="mod-ct">
        ...
        <div id="orderbody">
            ...
            <input id ="reallyPrice" :vlaue ="reallyPrice"  hidden>
            <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
                <div data-role="qrPayImg" class="qrcode-img-area">
                    <div class="ui-loading qrcode-loading" data-role="qrPayImgLoading" style="display: none;">加载中</div>
                    <div style="position: relative;display: inline-block;">
                        <img  id='show_qrcode' alt="加载中..." :src="'https://pay.csxds.com/enQrcode?url='+payUrl" width="210" height="210" style="display: block;">
...
<script>
    ...
    $.post("https://pay.mtyhq.cn/getOrder","orderId="+getQueryString("orderId"),function (data) {
        if (data.code==1){
            var time = new Date().getTime()-data.data.date;
            time = time/1000;
    ...
    function check() {
        $.post("https://pay.mtyhq.cn/checkOrder","orderId="+getQueryString("orderId"),function (data) {
            console.log(data);
            if (data.code == 1){
